...
public class AddArticleActivity extends AppCompatActivity implements FetchImageTask.ImageResponse {
  ...
  static EditText imageUrlEditText;
  @Bind(R.id.nanodegrees)
  TextView nanodegreesTextView;
  @Bind(R.id.btn_check_article)
  Button checkArticleButton;
  ...
  private static MaterialDialog imageSelectDialog;
  ...
  public void showImageSelectDialog(View view) {
    if (!articleUrlEditText.getText().toString().equals("")) {
      ...
      Toast.makeText(getBaseContext(), "Valid Article URL Needed", Toast.LENGTH_SHORT).show();
    }
  }
  ...
  public static void setImageUrl(String urlData) {
    imageUrlEditText.setText(urlData);
